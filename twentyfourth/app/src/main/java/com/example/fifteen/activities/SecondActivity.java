...
public class SecondActivity extends MyBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra(EXTRA_NOTE)) {
            ...
            currentNote = new Note("", "", new Time(System.currentTimeMillis()));
        ...
        TextWatcher watcher = new android.text.TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                okButton.setEnabled(!TextUtils.isEmpty(editTitle.getText().toString().trim())
                        && !TextUtils.isEmpty(editContent.getText().toString().trim()));
            }
        ...
        okButton.setOnClickListener(view -> {
            ...
            currentNote.setTime(new Time(System.currentTimeMillis()));
